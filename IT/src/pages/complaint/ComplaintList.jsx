...
export default function ComplaintList() {
  ...
  if (loading)
    return (
      <div className="p-4">
        <HRNavbar />
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-10 text-center text-slate-400 shadow-sm">
          Loading…
        </div>
      </div>
    );
      ...
      <div className="relative overflow-hidden rounded-3xl bg-slate-900 px-8 py-9 md:px-12">
        ...
        <div className="relative">
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-slate-400">
            Raise issues and track complaints across every portal in one place.
          </p>
        </div>
      </div>
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <div>
              ...
              <input
                ...
                placeholder="Short summary, e.g. Laptop not working"
